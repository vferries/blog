...
- [ ] **Titres anglais sur les 3 archives** : `_pages/category-archive.md`, `tag-archive.md` et `year-archive.md` s'appellent encore « Posts by Category / Tag / Year » (`<title>`, `<h1>` et `og:title`). Résidus du thème, jamais traduits — indépendants du chantier locale ci-dessus, qui ne touche que les chaînes du thème, pas le front matter
